...
## Este archivo se actualiza automáticamente desde el repositorio principal
## Si necesitas añadir cambios sin romper las actualizaciones puedes añadirlos
## al archivo ~/bashrc_custom que no se verá afectado ni modificado en ningún
## momento, manteniendo a tu riesgo y cuenta su contenido.
...
###     Configurando Bash-it    ###
###################################
if [ -f ~/.bashrc_custom ] #Comprobar si está instalado para el usuario
then
